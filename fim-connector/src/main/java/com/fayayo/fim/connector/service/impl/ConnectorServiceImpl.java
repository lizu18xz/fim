...
public class ConnectorServiceImpl implements ConnectorService {
    ...
    public void userChat(SendToUserRequest sendToUserRequest) {
        ...
        sendToChat(sendToUserRequest,url);
    }

    private void sendToChat(SendToUserRequest sendToUserRequest,URL url) {
        ...
        String result=restTemplate.postForObject(String.format(ChatReq.CHAT_POST_SEND_TO_USER, httpUrl),sendToUserRequest,String.class);
